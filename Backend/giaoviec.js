...
const filePath = path.join(__dirname, '../src/data/giaoviec.json');

exports.getGiaoviec = (req, res) => {
...
exports.postGiaoviec = (req, res) => {
    const { bophan, title, account, checklist, thoigian, date } = req.body;
    ...
    fs.access(filePath, fs.constants.F_OK, (accessErr) => {
        ...
        fs.readFile(filePath, 'utf8', (readErr, data) => {
            ...
            const newGiaoviec = { id, bophan, title, account, checklist, thoigian, date };
